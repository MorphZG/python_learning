...
prompt01 = 'Enter the string and i will tell you is it palindrome or not: '
palindrome_check = input(prompt01)
...
from the number 0. The first element in a list is “number 0”, the
second is “number 1”, etc.

As a result, when you want to get single elements out of a list, you
can ask a list for that number element:
...
often you should read from the list, or steps like every second or every third:
